...
Begin VB.Form frmGrupoDespesaCons 
   ...
   End
End
Attribute VB_Name = "frmGrupoDespesaCons"
...
On Error GoTo trata
  ...
  If cboGrupo.Text = "<TODOS>" Then
    strSql = "Select SUBGRUPODESPESA.CODIGO + ' - ' + SUBGRUPODESPESA.DESCRICAO FROM SUBGRUPODESPESA ORDER BY SUBGRUPODESPESA.CODIGO;"
  Else
    strSql = "Select SUBGRUPODESPESA.CODIGO + ' - ' + SUBGRUPODESPESA.DESCRICAO " & _
      ...
      " WHERE GRUPODESPESA.CODIGO = " & Formata_Dados(Left(cboGrupo.Text, 2), tpDados_Texto, tpNulo_Aceita) & _
...
Private Sub cmdConfirmar_Click()
  ...
  Case 0 'Chamada de Despesa
    'frmUserDespesaInc.mskGrupo.Text = Left(grdGeral.Columns(0).Value, 2)
    'frmUserDespesaInc.mskSubGrupo.Text = Mid(grdGeral.Columns(0).Value, 3, 2)
  Case 1 'Chamada de Despesa
    frmDespesaCtaInc.mskGrupo.Text = Left(grdGeral.Columns(0).Value, 2)
    frmDespesaCtaInc.mskSubGrupo.Text = Mid(grdGeral.Columns(0).Value, 3, 2)
...
Private Sub cmdFiltrar_Click()
  ...
  LINHASMATRIZ = 0
  If cboGrupo.Text <> "<TODOS>" Then
    strWhere = " WHERE GRUPODESPESA.CODIGO = " & Formata_Dados(Left(cboGrupo.Text, 2), tpDados_Texto, tpNulo_Aceita)
  End If
  If cboSubGrupo.Text <> "<TODOS>" Then
    ...
    End If
    strWhere = strWhere & "SUBGRUPODESPESA.CODIGO = " & Formata_Dados(Left(cboSubGrupo.Text, 2), tpDados_Texto, tpNulo_Aceita)
  End If
...
Public Sub MontaMatriz(Optional strWhere As String)
  ...
  strSql = "Select GRUPODESPESA.CODIGO + SUBGRUPODESPESA.CODIGO AS CODGRUPOSUBGRUPO, GRUPODESPESA.DESCRICAO, SUBGRUPODESPESA.DESCRICAO " & _
    "FROM GRUPODESPESA LEFT JOIN SUBGRUPODESPESA ON GRUPODESPESA.PKID = SUBGRUPODESPESA.GRUPODESPESAID "
...
On Error GoTo trata
  ...
  strSql = "Select GRUPODESPESA.CODIGO + ' - ' + GRUPODESPESA.DESCRICAO FROM GRUPODESPESA ORDER BY GRUPODESPESA.CODIGO"
