...
Public Sub VerificaQuemChamou()
  ...
  Case 1
    ...
    If Trim(grdGeral.Columns("Status").Value & "") = "A" Then
      MsgBox "Não pode haver alteração em uma GR Atendida.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "N" Then
      MsgBox "Não pode haver alteração em uma GR não Atendida.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "L" Then
      MsgBox "Não pode haver alteração em uma GR Liberada para atendimento.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "E" Then
      MsgBox "Não pode haver alteração em uma GR com confirmação de expiração.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "P" Then
      MsgBox "Não pode haver alteração em uma GR atendida a posteriore.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
  ...
  Case 3
    ...
    If Trim(grdGeral.Columns("Status").Value & "") = "A" Then
      MsgBox "Não pode haver pagamento em uma GR Atendida.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "N" Then
      MsgBox "Não pode haver pagamento em uma GR não Atendida.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "L" Then
      MsgBox "Não pode haver pagamento em uma GR Liberada para atendimento.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "E" Then
      MsgBox "Não pode haver pagamento em uma GR com confirmação de expiração.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "P" Then
      MsgBox "Não pode haver pagamento em uma GR atendida a posteriore.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
  ...
  Case 4
    ...
    If Trim(grdGeral.Columns("Status").Value & "") = "A" Then
      MsgBox "Não pode haver cancelamento em uma GR Atendida.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "N" Then
      MsgBox "Não pode haver cancelamento em uma GR não Atendida.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "L" Then
      MsgBox "Não pode haver cancelamento em uma GR Liberada para atendimento.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "E" Then
      MsgBox "Não pode haver cancelamento em uma GR com confirmação de expiração.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
    If Trim(grdGeral.Columns("Status").Value & "") = "P" Then
      MsgBox "Não pode haver cancelamento em uma GR atendida a posteriore.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
...
Private Sub Form_Load()
  ...
  If RetornaCodTurnoCorrente(datDataTurno) = 0 Then
    TratarErroPrevisto "Não há turnos em aberto, favor abrir um turno antes de iniciair as GR´s", "Form_Load"
  Else
    'OK Para turno
    ...
    If datDataTurno < datDataIniAtual Or datDataTurno >= datDataFimAtual Then
      TratarErroPrevisto "ATENÇÃO" & vbCrLf & vbCrLf & "A data do turno atual aberto não corresponde a data de hoje:" & vbCrLf & vbCrLf & "Data do turno --> " & Format(datDataTurno, "DD/MM/YYYY") & vbCrLf & "Data Atual --> " & Format(datDataIniAtual, "DD/MM/YYYY") & vbCrLf & vbCrLf & "Por favor, feche o turno e abra-o novamente. Caso você não realize esta operação, as GR´S lançadas não serão exibidas na consulta.", "Form_Load"
    End If
  End If
