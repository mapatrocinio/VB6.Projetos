...
Begin VB.Form frmParcelaInc 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.PictureBox pictrava 
            ...
            Begin MSMask.MaskEdBox mskDtPagamento 
               ...
               PromptChar      =   "_"
            End
            Begin MSMask.MaskEdBox mskVrPago 
               Height          =   255
               Left            =   1350
               TabIndex        =   4
               Top             =   1785
   ...
   End
End
Attribute VB_Name = "frmParcelaInc"
...
Private Sub TratarCampos()
  ...
  If intChamada = 1 Then
    'Indica que chamada foi da alteração da parcela
    Line1.Visible = True
    Label1.Visible = True
    Label5(4).Visible = True
    mskDtPagamento.Visible = True
    Label5(2).Visible = True
    mskVrPago.Visible = True
  Else
    'Indica que chamada foi da alteração da C/C
    Line1.Visible = False
    Label1.Visible = False
    Label5(4).Visible = False
    mskDtPagamento.Visible = False
    Label5(2).Visible = False
    mskVrPago.Visible = False
  End If
  Exit Sub
trata:
...
Private Sub LimparCampos()
  ...
  LimparCampoMask mskDtPagamento
  LimparCampoMask mskVrPago
  Exit Sub
trata:
  Err.Raise Err.Number, _
...
Private Function ValidaParcela() As Boolean
  ...
  End If
  '
  If Not Valida_Data(mskDtPagamento, TpNaoObrigatorio, blnSetarFocoControle) Then
    strMsg = strMsg & "Preencher a data de pagamento válido" & vbCrLf
  End If
  If Not Valida_Moeda(mskVrPago, TpNaoObrigatorio, blnSetarFocoControle) Then
    strMsg = strMsg & "Preencher o valor pago válido" & vbCrLf
  End If
  '
...
Private Sub Form_Load()
  ...
  ElseIf Status = tpStatus_Alterar Or Status = tpStatus_Consultar Then
    ...
    If Not objRs.EOF Then
      ...
      '
      INCLUIR_VALOR_NO_MASK mskDtPagamento, objRs.Fields("DTPAGAMENTO").Value & "", TpMaskData
      INCLUIR_VALOR_NO_MASK mskVrPago, objRs.Fields("VRPAGO").Value & "", TpMaskMoeda
    End If
    objRs.Close
    Set objRs = Nothing
    '
...
Private Sub mskDtPagamento_GotFocus()
  Seleciona_Conteudo_Controle mskDtPagamento
End Sub
Private Sub mskDtPagamento_LostFocus()
  Pintar_Controle mskDtPagamento, tpCorContr_Normal
End Sub
...
Private Sub mskVrPago_GotFocus()
  Seleciona_Conteudo_Controle mskVrPago
End Sub
Private Sub mskVrPago_LostFocus()
  Pintar_Controle mskVrPago, tpCorContr_Normal
End Sub
