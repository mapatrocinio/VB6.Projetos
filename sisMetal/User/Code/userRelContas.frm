...
Begin VB.Form frmRelContas 
   ...
   End
End
Attribute VB_Name = "frmRelContas"
...
Private Sub cmdRelatorio_Click()
  ...
  Else
    Report1.Formulas(2) = "CodigoGrupo = {GRUPODESPESA.CODIGO} = '" & Left(cboGrupo.Text, 2) & "'"
  End If
  If cboSubGrupo.Text = "" Or cboSubGrupo.Text = "<TODOS>" Then
    Report1.Formulas(3) = "CodigoSubGrupo = True = true"
  Else
    Report1.Formulas(3) = "CodigoSubGrupo = {SUBGRUPODESPESA.CODIGO} = '" & Left(cboSubGrupo.Text, 2) & "'"
  End If
