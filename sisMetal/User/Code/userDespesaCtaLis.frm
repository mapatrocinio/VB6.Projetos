...
Begin VB.Form frmDespesaCtaLis 
   ...
   End
End
Attribute VB_Name = "frmDespesaCtaLis"
...
Private Sub cmdAlterar_Click()
  ...
  If Trim(grdGeral.Columns("TIPO").Value & "") = "T" Then
    frmDespesaCtaInc.Status = tpStatus_Alterar
  Else
    frmDespesaCtaInc.Status = tpStatus_Alterar
  End If
  frmDespesaCtaInc.lngDESPESAID = grdGeral.Columns("ID").Value
  frmDespesaCtaInc.strTipo = Trim(grdGeral.Columns("TIPO").Value & "")
  frmDespesaCtaInc.Show vbModal
  
  If frmDespesaCtaInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  Dim objDespesa As busSisMetal.clsDespesaCta
  '
  On Error GoTo trata
  ...
  'OK
  Set objDespesa = New busSisMetal.clsDespesaCta
...
Private Sub cmdInserir_Click()
  ...
  frmDespesaCtaInc.Status = tpStatus_Incluir
  frmDespesaCtaInc.strTipo = "A" 'Administração
  frmDespesaCtaInc.Show vbModal
...
Private Sub cmdMudarConfig_Click()
  On Error GoTo trata
