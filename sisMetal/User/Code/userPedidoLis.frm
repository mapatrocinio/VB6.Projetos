...
'''    Set objRs = Nothing
'''    Set objGer = Nothing
'''    TratarErroPrevisto "Pedido não pode ser excluido pois já possui itens lançados.", "frmPedidoLis.cmdExcluir_Click"
'''    SetarFoco grdGeral
'''    Exit Sub
'''  End If
'''  objRs.Close
...
'''  '
'''  '
'''  If MsgBox("Confirma exclusão do Pedido " & grdGeral.Columns("Ano-OS").Value & "?", vbYesNo, TITULOSISTEMA) = vbNo Then Exit Sub
'''  'OK
