...
Begin VB.Form frmGrupoDespesaLis 
   ...
   End
End
Attribute VB_Name = "frmGrupoDespesaLis"
...
Private Sub cmdAlterar_Click()
  ...
  If Not IsNumeric(grdGeral.Columns("ID").Value) Then
    ...
    Exit Sub
  End If
  frmGrupoDespesaInc.Status = tpStatus_Alterar
  frmGrupoDespesaInc.lngGRUPODESPESAID = grdGeral.Columns("ID").Value
  frmGrupoDespesaInc.Show vbModal
  
  If frmGrupoDespesaInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  Dim objGrupoDespesa   As busSisMetal.clsGrupoDespesa
  ...
  Set objRs = Nothing
  Set objGeral = Nothing
  Set objGrupoDespesa = New busSisMetal.clsGrupoDespesa
...
Private Sub cmdInserir_Click()
  ...
  frmGrupoDespesaInc.Status = tpStatus_Incluir
  frmGrupoDespesaInc.Show vbModal
