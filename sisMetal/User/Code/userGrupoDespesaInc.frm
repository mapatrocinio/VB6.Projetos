...
Begin VB.Form frmGrupoDespesaInc 
   ...
   End
End
Attribute VB_Name = "frmGrupoDespesaInc"
...
Private Sub cmdAlterar_Click()
  ...
  If Not IsNumeric(grdGeral.Columns("ID").Value) Then
    ...
    Exit Sub
  End If
  frmSubGrupoDespesaInc.Status = tpStatus_Alterar
  frmSubGrupoDespesaInc.lngGRUPODESPESAID = lngGRUPODESPESAID
  frmSubGrupoDespesaInc.lngSUBGRUPODESPESAID = CLng(grdGeral.Columns("ID").Value)
  frmSubGrupoDespesaInc.Show vbModal
  
  If frmSubGrupoDespesaInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdInserir_Click()
  frmSubGrupoDespesaInc.Status = tpStatus_Incluir
  frmSubGrupoDespesaInc.lngGRUPODESPESAID = lngGRUPODESPESAID
  frmSubGrupoDespesaInc.Show vbModal
  ...
  Case 0 'Inclusão/Alteração
    ...
    ElseIf Status = tpStatus_Incluir Then
      ...
      objGrupoDespesa.IncluirGrupoDespesa mskGrupo.Text, _
                                          ...
                                          strTipo
      'CAPTURAR PKID
      strSql = "Select PKID From GRUPODESPESA WHERE CODIGO = " & Formata_Dados(mskGrupo.Text, tpDados_Texto, tpNulo_NaoAceita)
      Set objRs = clsGer.ExecutarSQL(strSql)
      If Not objRs.EOF Then
...
Private Function ValidaCampos() As Boolean
  ...
  '
  If Not IsNumeric(mskGrupo.Text) Or Len(mskGrupo.ClipText) <> 2 Then
