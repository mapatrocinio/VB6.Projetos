...
Begin VB.Form frmRelSaldoForn 
   Caption         =   "Saldo de Perfil no Fornecedor"
   ClientHeight    =   3825
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmRelSaldoForn"
...
Private Sub cmdRelatorio_Click()
  ...
  '
  Report1.Formulas(0) = "FORNECEDORID = " & IIf(lngFORNECEDORID = 0, "true = true", "{VW_CONS_ESTOQUE_PERFIL.FORNECEDORID} = " & lngFORNECEDORID) & ""
  '
  Report1.Action = 1
  '
  AmpN
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "EstoqueFornecedor.rpt"
  '
  AmpN
  Exit Sub
RotErro:
