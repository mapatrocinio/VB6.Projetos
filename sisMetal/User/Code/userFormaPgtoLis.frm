...
Begin VB.Form frmFormaPgtoLis 
   ...
   End
End
Attribute VB_Name = "frmFormaPgtoLis"
...
Private Sub cmdAlterar_Click()
  ...
  If Not IsNumeric(grdGeral.Columns("ID").Value) Then
    ...
    Exit Sub
  End If
  frmFormaPgtoInc.Status = tpStatus_Alterar
  frmFormaPgtoInc.lngFORMAPGTOID = grdGeral.Columns("ID").Value
  frmFormaPgtoInc.Show vbModal
  
  If frmFormaPgtoInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  Dim objFormaPgto  As busSisMetal.clsFormaPgto
  ...
  Set objGeral = Nothing
  'OK
  Set objFormaPgto = New busSisMetal.clsFormaPgto
...
Private Sub cmdInserir_Click()
  ...
  frmFormaPgtoInc.Status = tpStatus_Incluir
  frmFormaPgtoInc.Show vbModal
