...
Begin VB.Form frmConfigGeral 
   ...
   Caption         =   "Configurações do Sistema - Módulo Geral"
   ClientHeight    =   5865
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10380
   ...
   Begin TabDlg.SSTab tabDetalhes 
      ...
      TabsPerRow      =   1
      TabHeight       =   520
      TabCaption(0)   =   "&Cartão Promocional"
...
Private Function ValidaCampos() As Boolean
  ...
  If Not Valida_Moeda(mskQtdDiasVenda, TpObrigatorio, blnSetarFoco) Then
    ...
    strMsg = strMsg & "Preencher o Campo quantidade de dias para pedido ser exibido na venda válido" & vbCrLf
  End If
...
Private Sub LimparCampos()
  On Error GoTo trata
  'Configuração de Cortesia/promoções
