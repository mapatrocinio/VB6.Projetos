...
Sai:
  ...
  For intX = 1 To 2
    ...
    Case 2: strTexto = "Configurações Gerais"
    End Select
...
Private Sub DetalharItem(pConfigItem As String, _
  ...
  Case 0
    'Dados Cadastrais
    Set objForm = New SisMetal.frmConfigCadastro
    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
    objForm.Show vbModal
  Case 1
    'Configurações Gerais
    Set objForm = New SisMetal.frmConfigGeral
    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
    objForm.Show vbModal
'''  Case 1
'''    'Fechamento
'''    Set objForm = New SisMetal.frmUserConfigFechamento
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 2
'''    'Promoção/Cortesia
'''    Set objForm = New SisMetal.frmUserConfigCortesia
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 3
'''    'Locação
'''    Set objForm = New SisMetal.frmUserConfigLocacao
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 4
'''  Case 5
'''    'Telefonema, Entrada e Pedido
'''    Set objForm = New SisMetal.frmUserConfigTelEntrPed
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 6
'''    'Serv Despertador, Diária e Mov do Caixa
'''    Set objForm = New SisMetal.frmUserConfigDespDiaCaixa
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 7
'''    'Tabelas Diversas
'''    Set objForm = New SisMetal.frmUserConfigDiversos
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
  End Select
...
Private Sub Form_Load()
  ...
  Do While Not objRs.EOF
    ...
    With mNode ' Add node turno.
      .Text = objRs.Fields("TITULO").Value & ""
...
Private Function CarregaInfItem(ByRef ParentNode As MSComctlLib.node, _
  ...
  'Case 1: Set objForm = New SisMetal.frmUserConfigImpressao
  'Case 2: Set objForm = New SisMetal.frmUserConfigFechamento
  Case 3:
  Case 4:
  Case 5:
  Case 6:
