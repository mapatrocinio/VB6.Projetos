...
Begin VB.Form frmUserEntradaMaterialLis 
   ...
   End
End
Attribute VB_Name = "frmUserEntradaMaterialLis"
...
Private Sub cmdAlterar_Click()
  ...
  frmUserEntradaMaterialInc.lngENTRADAMATERIALID = grdGeral.Columns("ID").Value
  frmUserEntradaMaterialInc.Status = tpStatus_Alterar
  frmUserEntradaMaterialInc.intQuemChamou = 1 'Chamada da Alteração (Exclusão)
  frmUserEntradaMaterialInc.Show vbModal
  
  If frmUserEntradaMaterialInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdInserir_Click()
  ...
  frmUserEntradaMaterialInc.Status = tpStatus_Incluir
  frmUserEntradaMaterialInc.intQuemChamou = 0
  frmUserEntradaMaterialInc.lngENTRADAMATERIALID = 0
  frmUserEntradaMaterialInc.Show vbModal
...
Public Sub MontaMatriz(Optional strSelecao As String)
  ...
  '
  strSql = "SELECT ENTRADAMATERIAL.PKID, ENTRADAMATERIAL.CODIGO,  min(ENTRADAMATERIAL.DESCRICAO)AS DESCRICAO "
  strSql = strSql & " FROM ENTRADAMATERIAL LEFT JOIN ITEMENTRADA ON ENTRADAMATERIAL.PKID = ITEMENTRADA.ENTRADAMATERIALID " & _
            "GROUP BY ENTRADAMATERIAL.PKID, ENTRADAMATERIAL.CODIGO " & _
...
' nonnegative values of IndexFromBookmark() are valid.
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserEntradaMaterialLis.grdGeral_UnboundReadDataEx]"
End Sub
