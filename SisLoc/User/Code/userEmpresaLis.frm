...
Private Sub cmdAlterar_Click()
  ...
  If Not IsNumeric(grdGeral.Columns("PKID").Value & "") Then
    MsgBox "Selecione uma emrpesa !", vbExclamation, TITULOSISTEMA
    SetarFoco grdGeral
    Exit Sub
  End If
  
  frmUserEmpresaInc.Status = tpStatus_Alterar
  frmUserEmpresaInc.lngPKID = grdGeral.Columns("PKID").Value
  frmUserEmpresaInc.Show vbModal
  
  If frmUserEmpresaInc.blnRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  ...
  strSql = "SELECT * FROM CONTRATO WHERE EMPRESAID = " & Formata_Dados(grdGeral.Columns("PKID").Value, tpDados_Longo)
  Set objRs = objGeral.ExecutarSQL(strSql)
  If Not objRs.EOF Then
    objRs.Close
    Set objRs = Nothing
    Set objGeral = Nothing
    TratarErroPrevisto "Não é possível excluir esta empresa, pois existem contratos cadastrados associado a ele.", "[cmdExcluir_Click]"
    Exit Sub
  End If
  objRs.Close
  Set objRs = Nothing
  ...
  objEmpresa.ExcluirEmpresa CLng(grdGeral.Columns("PKID").Value)
...
Public Sub MontaMatriz()
  ...
  '
  'Chamada do Cadastro de Empresa
  strSql = "SELECT EMPRESA.PKID, EMPRESA.NOME "
  strSql = strSql & " FROM EMPRESA " & _
...
' nonnegative values of IndexFromBookmark() are valid.
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserEmpresa.grdGeral_UnboundReadDataEx]"
End Sub
