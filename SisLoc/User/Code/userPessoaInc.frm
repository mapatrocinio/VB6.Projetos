...
Private Sub cmdExcluir_Click()
  On Error GoTo trata
'''  Dim objPrestProcedimento      As busSisLoc.clsPrestProcedimento
'''  '
'''  Select Case tabDetalhes.Tab
...
'''      Exit Sub
'''    End If
'''    Set objPrestProcedimento = New busSisLoc.clsPrestProcedimento
...
Private Sub cmdOK_Click()
  Dim objPessoa                  As busSisLoc.clsPessoa
  Dim objFuncionario             As busSisLoc.clsFuncionario
'''  Dim objPaciente                As busSisLoc.clsPaciente
'''  Dim objPrestador               As busSisLoc.clsPrestador
  ...
  Set objPessoa = New busSisLoc.clsPessoa
...
'''    'Paciente
'''    Set objPaciente = New busSisLoc.clsPaciente
...
'''    End If
  If IcPessoa = tpIcPessoa_Func Then
    'Funcionario
    Set objFuncionario = New busSisLoc.clsFuncionario
...
'''  ElseIf IcPessoa = tpIcPessoa_Prest Then
'''    'Prestador
'''    Set objPrestador = New busSisLoc.clsPrestador
