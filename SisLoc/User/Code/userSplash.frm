...
Private Sub Form_Load()
  On Error GoTo trata
  Dim objRegister As busSisLoc.clsRegistro
  lblTitulo.Caption = TITULOSISTEMA
  chkConexao.Value = 1
  chkBanco.Value = 1
  'Inicializar variáveis do register
  Set objRegister = New busSisLoc.clsRegistro
...
Private Sub Timer2_Timer()
  ...
  '
  'Carga Unidade
  RectpIcUnidade.tpIcUnidade_M2 = "M2"
  RectpIcUnidade.tpIcUnidade_MLINEAR = "LINEAR"
  RectpIcUnidade.tpIcUnidade_UNID = "UNID"
  '
  Unload Me
  frmMDI.Show
  Exit Sub
