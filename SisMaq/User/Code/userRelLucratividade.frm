...
Begin VB.Form frmUserRelLucratividade 
   Caption         =   "Relatório de Lucratividade por Máquina"
   ClientHeight    =   4485
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
...
Private Sub cmdRelatorio_Click()
  ...
  Else
    strAscDesc = "+"
  End If
  If cboOrdenacao.Text = "Número da Máquina" Then
...
Private Sub Form_Load()
  ...
  '
  cboOrdenacao.AddItem "Número da Máquina"
  cboOrdenacao.AddItem "Lucro"
  cboOrdenacao.AddItem "Lucratividade"
  '
  cboOrdenacao.Text = "Número da Máquina"
  '
