...
Begin VB.Form frmUserDetalhamentoAtend 
      ...
      Begin MSComctlLib.ImageList imlSmallIcons 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":0000
               Key             =   "closed"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":059C
               Key             =   "closedgreen"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":0B38
               Key             =   "open"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":10D4
               Key             =   "opengreen"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":1670
               Key             =   "detalhenaook"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":198C
               Key             =   "detalheok"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":1CA8
               Key             =   "nocheck"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":2584
               Key             =   "vertexto"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":28A0
               Key             =   "check"
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":317C
               Key             =   "leaf"
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":32EE
               Key             =   "open_"
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "userDetalhamentoAtend.frx":3460
               Key             =   "smlBook"
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmUserDetalhamentoAtend"
...
Public Function RetornaChaveNo(strChave As String) As Long
  ...
  strRetorno = Replace(strRetorno, "CAIXAATENDID_", "")
  strRetorno = Replace(strRetorno, "A_", "")
  RetornaChaveNo = CLng(strRetorno)
  Exit Function
trata:
  Err.Raise Err.Number, "[frmUserDetalhamentoAtend.RetornaChaveNo]", Err.Description
End Function

Private Sub CarregarTurnoAtend(pTurno As String, _
...
Sai:
  ...
  '
  strSql = "SELECT CAIXAATEND.PKID, PESSOA.NOME, ISNULL(CAIXAATEND.TURNOFECHAID,0) AS TURNOFECHAID FROM CAIXAATEND " & _
      " INNER JOIN ATENDENTE ON ATENDENTE.PESSOAID = CAIXAATEND.ATENDENTEID " & _
      " INNER JOIN PESSOA ON PESSOA.PKID = ATENDENTE.PESSOAID " & _
      " WHERE TURNOENTRADAID = " & Formata_Dados(lngTURNOID, tpDados_Longo) & _
      " ORDER BY CAIXAATEND.PKID DESC"
      
  Set objRS = objGeral.ExecutarSQL(strSql)
  Do While Not objRS.EOF
    Set mNode = tvwDB.Nodes.Add(pTurno, tvwChild, "CAIXAATENDID_" & objRS.Fields("PKID").Value, objRS.Fields("NOME").Value, IIf(objRS.Fields("TURNOFECHAID").Value = 0, "closedgreen", "closed"))
    mNode.Tag = "CAIXAATEND" ' Identifies the table.
    objRS.MoveNext
  Loop
...
'  Set objLoc = Nothing
  Exit Sub
trata:
  Err.Raise Err.Number, "[frmUserDetalhamentoAtend.CarregarTurnoAtend]", Err.Description
End Sub
...
'  Set objLoc = Nothing
  Exit Sub
trata:
  Err.Raise Err.Number, "[frmUserDetalhamentoAtend.CarregarUnidades]", Err.Description
End Sub

Private Sub DetalharTurnoAtend(pLocacao As String, _
                             pNode As MSComctlLib.node)
  On Error GoTo trata:
  Dim objForm   As SisMaq.frmUserOperAteCons
  Set objForm = New SisMaq.frmUserOperAteCons
  '
  objForm.lngTURNOATENDEPESQ = RetornaChaveNo(pLocacao)
...
Private Sub Form_Load()
  ...
  Do While Not objRS.EOF
    ...
    If lngTotal = 1 Then
      ...
      CarregarTurnoAtend "TURNOID_" & objRS.Fields("PKID").Value, objRS.Fields("PKID").Value
    End If
    lngTotal = lngTotal + 1
    objRS.MoveNext
  Loop
...
Private Sub tvwDB_Collapse(ByVal node As MSComctlLib.node)
    ...
    If node.Tag = "CAIXAATEND" Then node.Image = IIf(node.Image = "opengreen", "closedgreen", "closed")
...
Private Sub tvwDB_Expand(ByVal node As MSComctlLib.node)
    ...
    node.Sorted = False
    If node.Tag = "CAIXAATEND" Then node.Image = IIf(node.Image = "closedgreen", "opengreen", "open")
    ...
    ' invoke the CarregaInfTurnoAtend function.
    'If node.Tag = "CAIXAATEND" And lngCurrentIndex <> RetornaChaveNo(node.Key) _
    'Then CarregaInfTurnoAtend node, Val(node.Key)
...
End Sub
'''
'''Private Function CarregaInfTurnoAtend(ByRef ParentNode As MSComctlLib.node, _
'''                                    pCAIXAATENDID As String) As Boolean
'''  On Error GoTo trata
...
'''  strSql = "SELECT BOLETOATEND.PKID, BOLETOATEND.NUMERO, BOLETOATEND.DATAENTRADA " & _
'''    " FROM BOLETOATEND " & _
'''    " WHERE BOLETOATEND.CAIXAATENDID=" & RetornaChaveNo(pCAIXAATENDID)
'''  '
'''  Set objRS = objGer.ExecutarSQL(strSql)
'''  '
'''  If objRS.EOF Then
'''    ' If no results, return a false and exit
'''    CarregaInfTurnoAtend = False
'''    Exit Function
'''  Else
'''    Do While Not objRS.EOF
'''      AddNode newNode, _
'''              ParentNode, _
'''              "BOLETOATENDID_" & objRS.Fields("PKID").Value, _
...
''''''      objRS.MoveNext
''''''  Loop
'''  CarregaInfTurnoAtend = True ' return true for success
'''
'''  ' Sort the Turnos nodes.
'''  tvwDB.Nodes(pCAIXAATENDID).Sorted = False
'''  ' Expand top node.
'''  tvwDB.Nodes(pCAIXAATENDID).Expanded = True
'''
'''  lngCurrentIndex = RetornaChaveNo(pCAIXAATENDID)
'''
'''  Set objGer = Nothing
'''  Exit Function
'''trata:
'''  Err.Raise Err.Number, "[frmUserDetalhamentoAtend.CarregarInfUnidades]", Err.Description
'''End Function
...
Private Sub tvwDB_NodeClick(ByVal node As MSComctlLib.node)
    ' If the Tag is "Publisher" and the mItelngCurrentIndex
    ' index isn't the same as the Node.key, then
    ' invoke the CarregaInfTurnoAtend function, which populates the Node.
    If node.Tag = "TURNO" And lngCurrentIndex <> RetornaChaveNo(node.Key) _
    Then CarregarTurnoAtend node.Key, RetornaChaveNo(node.Key), node
    
    If node.Tag = "CAIXAATEND" And lngCurrentIndex <> RetornaChaveNo(node.Key) _
    Then DetalharTurnoAtend RetornaChaveNo(node.Key), node
    
    If node.Tag = "DETALHAR" Then DetalharTurnoAtend node.Key, node
    'If node.Tag = "Publisher" Then PopStatus node
    node.Sorted = False
