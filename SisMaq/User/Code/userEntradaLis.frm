...
Begin VB.Form frmUserEntradaLis 
   ...
   Begin TrueDBGrid60.TDBGrid grdGeral 
      ...
      Height          =   4980
      Left            =   0
      OleObjectBlob   =   "userEntradaLis.frx":0000
      TabIndex        =   0
      Top             =   0
      Width           =   4305
   End
End
Attribute VB_Name = "frmUserEntradaLis"
...
Private Sub cmdAlterar_Click()
  ...
  If Not IsNumeric(grdGeral.Columns("PKID").Value & "") Then
    MsgBox "Selecione uma entrada !", vbExclamation, TITULOSISTEMA
    SetarFoco grdGeral
    Exit Sub
  End If
  
  frmUserEntradaInc.Status = tpStatus_Alterar
  frmUserEntradaInc.lngPKID = grdGeral.Columns("PKID").Value
  frmUserEntradaInc.Show vbModal
  
  If frmUserEntradaInc.blnRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  ...
  'Cadastro de Séries
  If Not IsNumeric(grdGeral.Columns("PKID").Value & "") Then
    MsgBox "Selecione uma entrada para exclusão.", vbExclamation, TITULOSISTEMA
    SetarFoco grdGeral
    Exit Sub
  End If
  '
  ...
  objEntrada.ExcluirEntrada CLng(grdGeral.Columns("PKID").Value)
...
Private Sub cmdInserir_Click()
  On Error GoTo trata
  frmUserEntradaInc.Status = tpStatus_Incluir
  frmUserEntradaInc.lngPKID = 0
  frmUserEntradaInc.Show vbModal
...
Public Sub MontaMatriz()
  ...
  '
  'Chamada do Cadastro de Entrada
  strSql = "SELECT ENTRADA.PKID, ENTRADA.DATA, ENTRADA.VALOR "
  strSql = strSql & " FROM ENTRADA " & _
...
' nonnegative values of IndexFromBookmark() are valid.
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserEntrada.grdGeral_UnboundReadDataEx]"
End Sub
