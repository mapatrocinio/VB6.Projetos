...
Begin VB.Form frmUserRelLucratividadeSerie 
   Caption         =   "Relatório de Lucratividade por Série"
   ClientHeight    =   4485
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmUserRelLucratividadeSerie"
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "LucratividadeSerie.rpt"
  '
