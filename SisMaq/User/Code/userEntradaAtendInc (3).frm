...
Private Sub cmdOk_Click()
  ...
  lngCAIXAATENDID = 0
  strSql = "SELECT CAIXAATEND.PKID FROM CAIXAATEND WHERE " & _
      " CAIXAATEND.ATENDENTEID = " & Formata_Dados(lngATENDENTEID, tpDados_Longo) & _
      " AND CAIXAATEND.TURNOENTRADAID = " & Formata_Dados(RetornaCodTurnoCorrente, tpDados_Longo)
  Set objRs = objGeral.ExecutarSQL(strSql)
  If Not objRs.EOF Then
