...
Begin VB.Form frmUserRetiradaInc 
   ...
   Begin TabDlg.SSTab tabDetalhes 
      ...
      TabPicture(0)   =   "userRetiradaInc.frx":0000
   ...
   End
End
Attribute VB_Name = "frmUserRetiradaInc"
...
trata:
  Err.Raise Err.Number, _
            "[frmUserRetiradaInc.LimparCampos]", _
            Err.Description
End Sub
...
Private Function ValidaCampos() As Boolean
  ...
  End If
  If Len(strMsg) <> 0 Then
    TratarErroPrevisto strMsg, "[frmUserRetiradaInc.ValidaCampos]"
    ValidaCampos = False
  Else
    ValidaCampos = True
  End If
...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[frmUserRetiradaInc.ValidaCampos]", _
            Err.Description
End Function
...
Private Sub Form_Activate()
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserRetiradaInc.Form_Activate]"
End Sub
...
Private Sub Form_Load()
  ...
  ElseIf Status = tpStatus_Alterar Or Status = tpStatus_Consultar Then
    Set objRetirada = New busSisMaq.clsRetirada
    Set objRs = objRetirada.SelecionarRetiradaPeloPkid(lngPKID)
    '
