...
Begin VB.Form frmUserRelMovMaquina 
   ...
   End
End
Attribute VB_Name = "frmUserRelMovMaquina"
...
Private Sub cmdRelatorio_Click()
  ...
  End If
  '
  lngSeq = objGeral.ExecutarSQLRetInteger("SP_REL_MOVIMENTO_MAQUINA_MOV", Array( _
  ...
  Report1.Formulas(1) = "DataFim = Date(" & Right(mskData(0).Text, 4) & ", " & Mid(mskData(0).Text, 4, 2) & ", " & Left(mskData(0).Text, 2) & ")"
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "MovimentoMaquina.rpt"
  '
