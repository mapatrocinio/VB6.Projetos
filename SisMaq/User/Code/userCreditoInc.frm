...
Begin VB.Form frmUserCreditoInc 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ajuste de lançamento do Arrecadador"
   ClientHeight    =   2880
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10290
   ...
   Begin TabDlg.SSTab tabDetalhes 
      ...
      TabPicture(0)   =   "userCreditoInc.frx":0000
   ...
   End
End
Attribute VB_Name = "frmUserCreditoInc"
...
trata:
  Err.Raise Err.Number, _
            "[frmUserCreditoInc.LimparCampos]", _
            Err.Description
End Sub
...
'''
'''    objCredito.InserirCredito lngTURNOID, _
'''                              mskValor.ClipText, _
'''                              strStatus, _
'''                              strData, _
'''                              giFuncionarioId
...
Private Function ValidaCampos() As Boolean
  ...
  If Len(strMsg) <> 0 Then
    TratarErroPrevisto strMsg, "[frmUserCreditoInc.ValidaCampos]"
    ValidaCampos = False
  Else
    ValidaCampos = True
  End If
...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[frmUserCreditoInc.ValidaCampos]", _
            Err.Description
End Function
...
Private Sub Form_Activate()
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserCreditoInc.Form_Activate]"
End Sub
...
Private Sub Form_Load()
  ...
  ElseIf Status = tpStatus_Alterar Or Status = tpStatus_Consultar Then
    Set objCredito = New busSisMaq.clsCredito
    Set objRs = objCredito.SelecionarCreditoPeloPkid(lngPKID)
    '
