...
Private Sub cmdExcluir_Click()
  Dim objLivro  As busSisMaq.clsLivro
  ...
  strSql = "Select * from DESPESA where LIVROID = " & grdGeral.Columns("ID").Value
  Set objRs = objGer.ExecutarSQL(strSql)
  If Not objRs.EOF Then
    objRs.Close
    Set objRs = Nothing
    Set objGer = Nothing
    TratarErroPrevisto "Livro não pode ser excluido, pois já está associado a Despesa.", "frmUserLivroLis.cmdExcluir_Click"
    SetarFoco grdGeral
    Exit Sub
  End If
  objRs.Close
  ...
  'OK
  Set objLivro = New busSisMaq.clsLivro
