...
Begin VB.Form frmUserRelPrestEsp 
   Caption         =   "Prestadores x Especialidades"
   ClientHeight    =   4485
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmUserRelPrestEsp"
...
Private Sub cmdRelatorio_Click()
  ...
  '
  Report1.Formulas(0) = "Prestador = '" & IIf(cboPrestador.Text = "<TODOS>", "*", cboPrestador.Text) & "'"
  '
  Report1.Action = 1
  '
  AmpN
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "Prestador.rpt"
  '
  'Prestadores
