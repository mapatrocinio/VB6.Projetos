...
Begin VB.Form frmUserRelGRCancFunc 
   Caption         =   "GR´s Canceladas por Funcionário"
   ClientHeight    =   4485
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmUserRelGRCancFunc"
...
Private Sub cmdRelatorio_Click()
  ...
  Report1.Formulas(2) = "Funcionario= '" & IIf(cboFuncionario.Text = "<TODOS>", "*", cboFuncionario.Text) & "'"
  '
  Report1.Action = 1
  '
  AmpN
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "GRCanceladaFunc.rpt"
  '
  ...
  PreencheCombo cboFuncionario, strSql, True, False, True
  AmpN
  Exit Sub
RotErro:
  TratarErro Err.Number, _
