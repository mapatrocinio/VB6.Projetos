...
Begin VB.Form frmUserRelNovoPacienteCons 
   ...
   End
End
Attribute VB_Name = "frmUserRelNovoPacienteCons"
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "NovoPacienteCons.rpt"
  '
  mskData(0).Text = "01/" & Format(Year(Now), "0000")
  mskData(1).Text = Format(Month(Now), "00") & "/" & Format(Year(Now), "0000")
  '
  AmpN
  Exit Sub
RotErro:
