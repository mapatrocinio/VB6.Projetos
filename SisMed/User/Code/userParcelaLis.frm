...
Private Sub cmdAlterar_Click()
  ...
  frmUserParcelaInc.intChamada = 0
  frmUserParcelaInc.lngParcelaId = grdGeral.Columns("PKID").Value
  frmUserParcelaInc.strFuncionarioNome = strFuncionarioNome
...
'''  End If
  ...
  Me.Caption = Me.Caption & " - " & strFuncionarioNome
...
' nonnegative values of IndexFromBookmark() are valid.
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserParcelaLis.grdGeral_UnboundReadDataEx]"
End Sub
