...
Begin VB.Form frmUserCartaoDebitoLis 
   ...
   End
End
Attribute VB_Name = "frmUserCartaoDebitoLis"
...
Private Sub cmdAlterar_Click()
  ...
  frmUserCartaoDebitoInc.lngCARTAOID = grdGeral.Columns("ID").Value
  frmUserCartaoDebitoInc.Status = tpStatus_Alterar
  frmUserCartaoDebitoInc.intQuemChamou = 1 'Chamada da Alteração (Exclusão)
  frmUserCartaoDebitoInc.Show vbModal
  
  If frmUserCartaoDebitoInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  ...
  '
'''  strSql = "Select * from LOCACAO where CARTAODEBITOID = " & grdGeral.Columns("ID").Value
'''  Set objRs = objGer.ExecutarSQL(strSql)
'''  If Not objRs.EOF Then
'''    objRs.Close
'''    Set objRs = Nothing
'''    Set objGer = Nothing
'''    TratarErroPrevisto "Cartão de Débito não pode ser excluido, pois já está associado a locações.", "frmUserCartaoDebitoDebitoLis.cmdExcluir_Click"
'''    SetarFoco grdGeral
'''    Exit Sub
'''  End If
'''  objRs.Close
...
Private Sub cmdInserir_Click()
  ...
  frmUserCartaoDebitoInc.Status = tpStatus_Incluir
  frmUserCartaoDebitoInc.intQuemChamou = 0
  frmUserCartaoDebitoInc.lngCARTAOID = 0
  frmUserCartaoDebitoInc.Show vbModal
...
Public Sub MontaMatriz()
  ...
  strSql = "SELECT CARTAODEBITO.PKID, CARTAODEBITO.NUMERO, CARTAODEBITO.PERCTAXAADMIN, CARTAODEBITO.INDCONVENIO, CARTAODEBITO.NOME " & _
            "FROM CARTAODEBITO " & _
            "ORDER BY NOME"
  '
