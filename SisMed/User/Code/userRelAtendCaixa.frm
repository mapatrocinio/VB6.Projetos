...
Begin VB.Form frmUserRelAtendCaixa 
   Caption         =   "Atendimento no caixa e laboratório"
   ClientHeight    =   4485
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmUserRelAtendCaixa"
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "AtendCaixaLab.rpt"
  '
