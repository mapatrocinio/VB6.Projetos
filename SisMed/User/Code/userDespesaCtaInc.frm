...
Private Sub cmdOk_Click()
  ...
  Case 0 'Inclusão/Alteração da Despesa
    ...
    If cboLivro.Text <> "" Then
      strSql = "Select PKID From LIVRO WHERE NUMEROLIVRO = " & Formata_Dados(cboLivro.Text, tpDados_Texto, tpNulo_NaoAceita)
    ...
    ElseIf Status = tpStatus_Incluir Then
      ...
      '
      lngSEQUENCIALEXTERNO = CLng(RetornaGravaSequencial("SEQUENCIALDESP"))
...
Private Function ValidaCampos() As Boolean
  ...
  Dim objSubGrupoDespesa  As busSisMed.clsSubGrupoDespesa
  ...
  If strTipoDespesa <> "C" Then
    ...
    End If
    If Not Valida_Moeda(mskValorPagar, TpNaoObrigatorio) Then
...
On Error GoTo trata
  ...
  strSql = "SELECT NUMEROLIVRO FROM LIVRO ORDER BY NUMEROLIVRO;"
...
Private Sub mskSubGrupo_LostFocus()
  ...
  If Valida_Moeda(mskGrupo, TpObrigatorio) And Valida_Moeda(mskSubGrupo, TpObrigatorio) Then
    ...
    strTipo = objSubGrupoDespesa.SelecionarTipoGrupo(mskGrupo.Text, _
                                                     mskSubGrupo.Text)
    If strTipo = "C" Then SetarFoco txtDescricao
    Set objSubGrupoDespesa = Nothing
  End If
  Exit Sub
trata:
