...
Private Sub cmdExcluir_Click()
  Dim objDespesa As busSisMed.clsDespesaCta
  '
  On Error GoTo trata
  ...
  'OK
  Set objDespesa = New busSisMed.clsDespesaCta
...
Public Sub MontaMatriz()
  ...
  If strTipoCtaPagas = "N" Then
    strSql = "SELECT DESPESA.PKID, DESPESA.TIPO, DESPESA.SEQUENCIAL, case DESPESA.TIPO when 'T' then 'Telefonista' when 'A' then 'Administração' else '' end, convert(varchar(20), GRUPODESPESA.CODIGO) + convert(varchar(20), SUBGRUPODESPESA.CODIGO) + ' - ' + SUBGRUPODESPESA.DESCRICAO, DESPESA.DESCRICAO, DESPESA.DT_PAGAMENTO, DESPESA.VR_PAGO " & _
