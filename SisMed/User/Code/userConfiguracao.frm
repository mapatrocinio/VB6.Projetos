...
'''  Case 0
'''    'impressão
'''    Set objForm = New SisMed.frmUserConfigImpressao
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 1
'''    'Fechamento
'''    Set objForm = New SisMed.frmUserConfigFechamento
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 2
'''    'Promoção/Cortesia
'''    Set objForm = New SisMed.frmUserConfigCortesia
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 3
'''    'Locação
'''    Set objForm = New SisMed.frmUserConfigLocacao
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
  Case 0
    'Dados Cadastrais
    Set objForm = New SisMed.frmUserConfigCadastro
    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
    objForm.Show vbModal
'''  Case 5
'''    'Telefonema, Entrada e Pedido
'''    Set objForm = New SisMed.frmUserConfigTelEntrPed
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 6
'''    'Serv Despertador, Diária e Mov do Caixa
'''    Set objForm = New SisMed.frmUserConfigDespDiaCaixa
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
'''  Case 7
'''    'Tabelas Diversas
'''    Set objForm = New SisMed.frmUserConfigDiversos
'''    objForm.lngCONFIGID = RetornaChaveNo(pNode.Parent.Key)
'''    objForm.Show vbModal
  End Select
...
Private Function CarregaInfItem(ByRef ParentNode As MSComctlLib.node, _
  ...
  Case 1: 'Set objForm = New SisMed.frmUserConfigImpressao
  Case 2: 'Set objForm = New SisMed.frmUserConfigFechamento
  Case 3:
  Case 4:
  Case 5:
  Case 6:
