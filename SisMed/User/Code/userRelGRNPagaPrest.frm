...
Begin VB.Form frmUserRelGRNPagaPrest 
   Caption         =   "GR não paga a prestadores"
   ClientHeight    =   4485
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmUserRelGRNPagaPrest"
...
Private Sub Form_Load()
  ...
  Report1.ReportFileName = gsReportPath & "GRNPgPrest.rpt"
  '
