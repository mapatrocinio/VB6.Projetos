...
Begin VB.Form frmUserRelReceitaEspec 
   ...
   End
End
Attribute VB_Name = "frmUserRelReceitaEspec"
...
Private Sub cmdRelatorio_Click()
  ...
  If chkData.Value = 1 Then
    ...
    Report1.ReportFileName = gsReportPath & "ReceitaPrest.rpt"
    '
  Else
    Report1.Connect = ConnectRpt
    Report1.ReportFileName = gsReportPath & "ReceitaPrestTot.rpt"
    '
  End If
