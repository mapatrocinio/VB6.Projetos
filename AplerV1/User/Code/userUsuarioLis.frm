...
Private Sub cmdExcluir_Click()
  Dim objUsuario  As busApler.clsUsuario
...
'''  Set objRs = Nothing
  ...
  End If
  'OK
  Set objUsuario = New busApler.clsUsuario
...
Public Sub MontaMatriz()
  ...
  If intBancoDados = TpTipoBD.TpTipoBD_ACCESS Then
    strSql = "SELECT CONTROLEACESSO.PKID, CONTROLEACESSO.USUARIO, IIF(CONTROLEACESSO.NIVEL='ADM','ADMINISTRADOR',IIF(CONTROLEACESSO.NIVEL='DIR','DIRETOR',IIF(CONTROLEACESSO.NIVEL='GER','GERENTE',IIF(CONTROLEACESSO.NIVEL='POR','PORTARIA',IIF(CONTROLEACESSO.NIVEL='REC','RECEPÇÃO','ESTOQUISTA'))))) AS NIVEL " & _
