...
Public Sub MontaMatriz()
  ...
  strSql = "SELECT ASSOCIADO.PKID, ASSOCIADO.ICASSOCIADO, ASSOCIADO.NOME, ASSOCIADO.ICASSOCIADO, ASSOCIADO.CPF, ASSOCIADO.DATANASCIMENTO "
  strSql = strSql & " FROM ASSOCIADO " & _
