...
Private Sub cmdOK_Click()
  ...
  Case 0 'Inclusão/Alteração de Grupo cardápio
    ...
    If Not objRs.EOF Then
      ...
      Set objRs = Nothing
      Set objGer = Nothing
      TratarErroPrevisto "Usuario já cadastrado", "cmdOK_Click"
...
Private Sub Form_Load()
  ...
  cboNivel.AddItem "ESTOQUISTA"
  cboNivel.AddItem "FINANCEIRO"
  cboNivel.AddItem "GERENTE"
  cboNivel.AddItem "PORTARIA"
  cboNivel.AddItem "RECEPÇÃO"
