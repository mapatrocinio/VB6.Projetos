...
Begin VB.Form frmGerencial 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.CommandButton cmdSelecao 
         ...
         Left            =   5460
         TabIndex        =   5
         ToolTipText     =   "Observação do Serviço"
         Top             =   240
         Width           =   1305
      End
      Begin VB.CommandButton cmdSelecao 
         Caption         =   "&F - Tranf. Serviço    "
         BeginProperty Font 
            Name            =   "Small Fonts"
            Size            =   6.75
            Charset         =   0
         ...
         Left            =   6780
         TabIndex        =   6
         ToolTipText     =   "Transferir Serviço"
         Top             =   240
         Width           =   1305
      End
      Begin VB.CommandButton cmdSelecao 
...
'''  Dim objPacoteInc As Elite.frmPacoteInc
  ...
  Case 1
    'Alteração do Pacote
    If Len(Trim(grdGeral.Columns("ID").Value & "")) = 0 Then
      MsgBox "Selecione um Pacote para alterá-lo.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
...
'''    End If
  ...
  Case 2
    'Consultar Pacote
    If Len(Trim(grdGeral.Columns("ID").Value & "")) = 0 Then
      MsgBox "Selecione um Pacote para consultá-lo.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
'''    If Trim(grdGeral.Columns("Status").Value & "") <> "I" And Trim(grdGeral.Columns("Status").Value & "") <> "C" Then
...
'''    End If
    ...
    frmPacoteInc.Show vbModal
  Case 3
    'Finalizar Serviço do Pacote
    If Len(Trim(grdGeral.Columns("ID").Value & "")) = 0 Then
      MsgBox "Selecione um Pacote para finalizar um serviço.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
  ...
  Case 4
    'Observar Serviço do Pacote
    If Len(Trim(grdGeral.Columns("ID").Value & "")) = 0 Then
      MsgBox "Selecione um Pacote para lançar uma observação no serviço.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
  ...
  Case 5
    'Observar Serviço do Pacote
    If Len(Trim(grdGeral.Columns("ID").Value & "")) = 0 Then
      MsgBox "Selecione um Pacote para transferir um serviço.", vbExclamation, TITULOSISTEMA
      SetarFoco grdGeral
      Exit Sub
    End If
