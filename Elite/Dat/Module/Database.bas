...
Public Const strClassName As String = "datElite"

Function GetConnectionString() As String
  On Error GoTo errorHandler
  Dim objRegistro       As datElite.clsRegistro
  Dim strNomeBD         As String
  Set objRegistro = New datElite.clsRegistro
  ...
  GetConnectionString = "Provider=SQLOLEDB" & _
    ";Initial Catalog=Elite" & _
    ";Data Source=" & strNomeBD & _
    ";User Id=SA" & _
    ";Password=21321"
  'GetConnectionString = "DSN=Elite" & _
