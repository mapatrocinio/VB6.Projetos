...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[Database.RetonaProximoSequencial]", _
            Err.Description
End Function
Function GetConnectionString() As String
  On Error GoTo errorHandler
  Dim objRegistro       As datSisContas.clsRegistro
  Dim strNomeBD         As String
  Set objRegistro = New datSisContas.clsRegistro
