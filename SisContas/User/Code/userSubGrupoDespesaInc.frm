...
Begin VB.Form frmUserSubGrupoDespesaInc 
   ...
   End
End
Attribute VB_Name = "frmUserSubGrupoDespesaInc"
  ...
  Case 0 'Inclusão/Alteração
    ...
    ElseIf Status = tpStatus_Incluir Then
      ...
      objSubGrupoDespesa.IncluirSubGrupoDespesa lngGRUPODESPESAID, _
                                                mskSubGrupo.Text, _
                                                txtDescricao.Text
      INCLUIR_VALOR_NO_MASK mskSubGrupo, "____", TpMaskOutros
      txtDescricao.Text = ""
      bRetorno = True
...
Private Function ValidaCampos() As Boolean
  ...
  '
  If Not IsNumeric(mskSubGrupo.Text) Or Len(mskSubGrupo.ClipText) <> 4 Then
