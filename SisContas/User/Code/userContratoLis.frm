...
Private Sub cmdAlterar_Click()
  ...
  frmUserContratoInc.lngPKID = grdGeral.Columns("PKID").Value
...
Private Sub cmdExcluir_Click()
  Dim objContrato         As busSisContas.clsContrato
  ...
  End If
  'OK
  Set objContrato = New busSisContas.clsContrato
  objContrato.ExcluirContrato CLng(grdGeral.Columns("PKID").Value)
...
Public Sub MontaMatriz()
  ...
  '
  'Chamada do Cadastro de Contratos
  strSql = "SELECT CONTRATO.PKID, CONTRATO.DESCRICAO, CASE CONTRATO.STATUS WHEN 'A' THEN 'Ativo' ELSE 'Inativo' END "
  strSql = strSql & " FROM CONTRATO " & _
            " WHERE PARCEIROID = " & Formata_Dados(glParceiroId, tpDados_Longo) & _
            " ORDER BY CONTRATO.DESCRICAO"
  '
...
' nonnegative values of IndexFromBookmark() are valid.
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserContrato.grdGeral_UnboundReadDataEx]"
End Sub
