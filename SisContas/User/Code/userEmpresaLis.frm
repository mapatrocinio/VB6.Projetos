...
Begin VB.Form frmUserEmpresaLis 
   ...
   Begin TrueDBGrid60.TDBGrid grdGeral 
      ...
      Height          =   4980
      Left            =   0
      OleObjectBlob   =   "userEmpresaLis.frx":0000
      TabIndex        =   0
      Top             =   0
      Width           =   8160
   End
End
Attribute VB_Name = "frmUserEmpresaLis"
...
Private Sub cmdAlterar_Click()
  ...
  frmUserEmpresaInc.lngEMPRESAID = grdGeral.Columns("ID").Value
  frmUserEmpresaInc.Status = tpStatus_Alterar
  frmUserEmpresaInc.Show vbModal
  
  If frmUserEmpresaInc.bRetorno Then
    MontaMatriz
...
Private Sub cmdExcluir_Click()
  ...
  If Not objRs.EOF Then
    ...
    TratarErroPrevisto "Empresa não pode ser excluida, pois há locações associadas a ela.", "frmUserEmpresaLis.cmdExcluir_Click"
    SetarFoco grdGeral
    Exit Sub
  End If
  objRs.Close
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaLis.cmdExcluir_Click]"
End Sub
...
Private Sub cmdInserir_Click()
  ...
  frmUserEmpresaInc.Status = tpStatus_Incluir
  frmUserEmpresaInc.intQuemChamou = 0
  frmUserEmpresaInc.lngEMPRESAID = 0
  frmUserEmpresaInc.Show vbModal
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaLis.cmdInserir_Click]"
  AmpN
End Sub
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaLis.Form_Load]"
  AmpN
End Sub
...
Public Sub MontaMatriz()
  ...
  '
  strSql = "SELECT EMPRESA.PKID, EMPRESA.NOME,  EMPRESA.TEL, EMPRESA.CONTATO " & _
            "FROM EMPRESA " & _
...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[frmUserEmpresaLis.Form_Load]", _
            Err.Description
End Sub
...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[frmUserEmpresaLis.grdGeral_UnboundReadDataEx]", _
            Err.Description
End Sub
