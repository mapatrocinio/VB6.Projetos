...
Public Sub FAIXA_MontaMatriz()
  ...
  '
  strSql = "SELECT EMPRESACTRTO.PKID, EMPRESACTRTO.DESCRICAO, EMPRESA.NOME, EMPRESACTRTO.VALOR, CASE EMPRESACTRTO.STATUS WHEN 'A' THEN 'Ativo' ELSE 'Inativo' END  " & _
          "FROM EMPRESACTRTO INNER JOIN EMPRESA ON EMPRESA.PKID = EMPRESACTRTO.EMPRESAID " & _
