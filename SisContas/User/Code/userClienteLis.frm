...
Begin VB.Form frmUserClienteLis 
   ...
   Begin TrueDBGrid60.TDBGrid grdGeral 
      ...
      Height          =   4980
      Left            =   0
      OleObjectBlob   =   "userClienteLis.frx":0000
      TabIndex        =   0
      Top             =   0
      Width           =   8160
   End
End
Attribute VB_Name = "frmUserClienteLis"
...
Private Sub cmdExcluir_Click()
  ...
  objRs.Close
  Set objRs = Nothing
  If MsgBox("Confirma exclusão do cliente com CPF " & grdGeral.Columns("CPF").Value & "?", vbYesNo, TITULOSISTEMA) = vbNo Then
    SetarFoco grdGeral
    Exit Sub
  End If
  'OK
...
Public Sub MontaMatriz()
  ...
  '
  strSql = "SELECT CLIENTE.PKID, CLIENTE.CPF,  CLIENTE.NOME, DTNASCIMENTO " & _
            "FROM CLIENTE " & _
            "ORDER BY CPF"
  '
...
' nonnegative values of IndexFromBookmark() are valid.
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserClienteLis.grdGeral_UnboundReadDataEx]"
End Sub
