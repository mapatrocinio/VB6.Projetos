...
Begin VB.Form frmUserRelResumoReceitas 
   Caption         =   "Demonstrativo de Resumo Geral de Receitas"
   ClientHeight    =   3840
   ClientLeft      =   450
   ClientTop       =   1920
   ClientWidth     =   6105
   ...
   End
End
Attribute VB_Name = "frmUserRelResumoReceitas"
...
Private Sub Form_Load()
  ...
  '
  Report1.ReportFileName = gsReportPath & "ResumoReceitas.rpt"
