...
Public Sub MontaMatriz()
  ...
  '
  strSql = "SELECT GRUPODESPESA.PKID, GRUPODESPESA.CODIGO, GRUPODESPESA.DESCRICAO, IIF(GRUPODESPESA.TIPO='D', 'DÉBITO', IIF(GRUPODESPESA.TIPO='C', 'CRÉDITO', '')) FROM GRUPODESPESA " & _
