...
Public Sub MontaMatriz()
  ...
  '
  If strStatus = "M" Then
    strSql = "SELECT MOVIMENTACAO.PKID, FORMAT(MOVIMENTACAO.DATA, 'DD/MM/YYYY'), CONTADEB.DESCRICAO, CONTACRED.DESCRICAO, FORMAT(MOVIMENTACAO.VALOR, '###,##0.00'), MOVIMENTACAO.DESCRICAO " & _
  ...
  ElseIf strStatus = "D" Then
    strSql = "SELECT MOVIMENTACAO.PKID, FORMAT(MOVIMENTACAO.DATA, 'DD/MM/YYYY'), CONTADEB.DESCRICAO, '', FORMAT(MOVIMENTACAO.VALOR, '###,##0.00'), MOVIMENTACAO.DESCRICAO " & _
              "FROM MOVIMENTACAO LEFT JOIN CONTA AS CONTADEB ON CONTADEB.PKID = MOVIMENTACAO.CONTADEBITOID " & _
              " WHERE STATUS = " & Formata_Dados(strStatus, tpDados_Texto, tpNulo_NaoAceita) & _
              " ORDER BY MOVIMENTACAO.DATA DESC, MOVIMENTACAO.PKID DESC "
  ElseIf strStatus = "C" Then
    strSql = "SELECT MOVIMENTACAO.PKID, FORMAT(MOVIMENTACAO.DATA, 'DD/MM/YYYY'), CONTACRED.DESCRICAO, '', FORMAT(MOVIMENTACAO.VALOR, '###,##0.00'), MOVIMENTACAO.DESCRICAO " & _
