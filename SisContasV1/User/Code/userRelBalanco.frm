...
Private Sub cmdRelatorio_Click()
  ...
  If chkSaldoAntCart.Value = 0 Then
    'Pegar salda anterior do cartão do sismotel
    strSql = "SELECT Sum(cons_t_cred.VrCalcDescCartTxAdm) as VrCalcDescCartTxAdm, Sum(cons_t_cred.PGTOCARTAO) As PGTOCARTAO " & _
