...
Begin VB.Form frmUserQualificacaoInc 
   ...
   Caption         =   "Inclusão da Qualificação"
   ClientHeight    =   2565
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10380
   ...
   Begin TabDlg.SSTab tabDetalhes 
      ...
      Tabs            =   1
      TabHeight       =   520
      TabCaption(0)   =   "&Dados da Qualificação"
...
Private Sub cmdOK_Click()
  ...
  Case 0 'Inclusão/Alteração de Grupo cardápio
    ...
    If Not objRs.EOF Then
      ...
      Set objRs = Nothing
      Set objGer = Nothing
      TratarErroPrevisto "Qualificação já cadastrada", "cmdOK_Click"
...
Private Function ValidaCampos() As Boolean
  ...
  If Len(txtDescricao.Text) = 0 Then
    strMsg = strMsg & "Informar a descrição da Qualificação" & vbCrLf
    Pintar_Controle txtDescricao, tpCorContr_Erro
    SetarFoco txtDescricao
  End If
  '
