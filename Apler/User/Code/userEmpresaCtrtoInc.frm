...
Private Sub cmdOK_Click()
  ...
  'Obtem Tipo Empresa
  Set objGeral = New busApler.clsGeral
  strSql = "SELECT PKID FROM EMPRESACTA WHERE NOME = " & Formata_Dados(cboEmpresa.Text, tpDados_Texto)
  ...
  strSql = "SELECT * FROM EMPRESACTRTO " & _
    " WHERE EMPRESACTAID = " & Formata_Dados(lngEMPRESAID, tpDados_Longo) & _
...
Private Sub Form_Load()
  ...
  strSql = "SELECT NOME FROM EMPRESACTA " & _
...
Private Sub tabDetalhes_Click(PreviousTab As Integer)
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "Apler.frmUserEmpresaCtrtoInc.tabDetalhes"
  AmpN
End Sub
