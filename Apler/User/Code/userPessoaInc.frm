   ...
   Begin TabDlg.SSTab tabDetalhes 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.PictureBox pictrava 
            ...
            Top             =   3870
            Width           =   7575
            Begin VB.ComboBox cboQualificacao 
               Height          =   315
               Left            =   4740
...
Private Sub LimparCampos()
  ...
  LimparCampoCombo cboQualificacao
...
Private Sub cboQualificacao_LostFocus()
  Pintar_Controle cboQualificacao, tpCorContr_Normal
End Sub
Private Sub cmdAlterar_Click()
  On Error GoTo trata
  'Dim objFormProcPrestador As Apler.frmUserProcPrestadorInc
...
'''    End If
'''
'''    Set objFormProcPrestador = New Apler.frmUserProcPrestadorInc
...
Private Sub cmdExcluir_Click()
  On Error GoTo trata
'''  Dim objPrestProcedimento      As busApler.clsPrestProcedimento
'''  '
'''  Select Case tabDetalhes.Tab
...
'''      Exit Sub
'''    End If
'''    Set objPrestProcedimento = New busApler.clsPrestProcedimento
...
Private Sub cmdOK_Click()
  Dim objPessoa                  As busApler.clsPessoa
  Dim objFuncionario             As busApler.clsFuncionario
'''  Dim objPaciente                As busApler.clsPaciente
'''  Dim objPrestador               As busApler.clsPrestador
  ...
  Set objPessoa = New busApler.clsPessoa
...
'''    'Paciente
'''    Set objPaciente = New busApler.clsPaciente
...
'''    End If
  If IcPessoa = tpIcPessoa_Func Then
    'Funcionario
    Set objFuncionario = New busApler.clsFuncionario
...
'''  ElseIf IcPessoa = tpIcPessoa_Prest Then
'''    'Prestador
'''    Set objPrestador = New busApler.clsPrestador
...
'''      tabDetalhes.TabEnabled(3) = True
    If IcPessoa = tpIcPessoa.tpIcPessoa_Func Then
      ...
      If Not objRs.EOF Then
        ...
        End If
        If objRs.Fields("DESCQUALIFICACAO").Value & "" <> "" Then
          cboQualificacao.Text = objRs.Fields("DESCQUALIFICACAO").Value & ""
        End If
        '
        If objRs.Fields("INDEXCLUIDO").Value & "" = "S" Then
