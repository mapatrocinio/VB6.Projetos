...
Begin VB.Form frmUserEmpresaCtaInc 
   ...
   Begin TabDlg.SSTab tabDetalhes 
      ...
      TabPicture(0)   =   "userEmpresaCtaInc.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "fraProf"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "&Endereço"
      TabPicture(1)   =   "userEmpresaCtaInc.frx":001C
      ...
      Begin VB.Frame fraProf 
         ...
         Begin VB.PictureBox picTrava 
            ...
            Begin VB.TextBox txtObservacao 
               ...
               MultiLine       =   -1  'True
               TabIndex        =   14
               Text            =   "userEmpresaCtaInc.frx":0038
               Top             =   2940
               Width           =   6135
            End
   ...
   End
End
Attribute VB_Name = "frmUserEmpresaCtaInc"
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaCtaInc.chkEndCobIgualEndCorr_Click]"
End Sub
...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[frmUserEmpresaCtaInc.HabDesEndCob]", _
            Err.Description
End Sub
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaCtaInc.cmdCancelar_Click]"
  Unload Me
End Sub
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaCtaInc.cmdOk_Click]"
End Sub
...
Private Function ValidaCamposEmpresa() As Boolean
  ...
  '
  If Len(strMsg) <> 0 Then
    TratarErroPrevisto strMsg, "[frmUserEmpresaCtaInc.ValidaCamposEmpresa]"
...
trata:
  Err.Raise Err.Number, _
            Err.Source & ".[frmUserEmpresaCtaInc.ValidaCamposEmpresa]", _
            Err.Description
End Function
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaCtaInc.Form_Activate]"
End Sub
...
On Error GoTo trata
  ...
  ElseIf Status = tpStatus_Alterar Or Status = tpStatus_Consultar Then
    ...
    If Not objRs.EOF Then
      ...
      If objRs.Fields("DESCRTIPOEMPRESACTA").Value & "" <> "" Then
        cboTipo = objRs.Fields("DESCRTIPOEMPRESACTA").Value & ""
      End If
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaCtaInc.Form_Load]"
  AmpN
  Unload Me
End Sub
...
trata:
  TratarErro Err.Number, _
             Err.Description, _
             Err.Source & ".[frmUserEmpresaCtaInc.tabDetalhes_Click]"
  AmpN
End Sub
