...
Begin VB.Form frmUserOrigemInc 
   ...
   End
End
Attribute VB_Name = "frmUserOrigemInc"
...
Private Sub cmdOK_Click()
  ...
  Case 0 'Inclusão/Alteração de Grupo cardápio
    ...
    strSql = "Select * From ORIGEM WHERE DESCRICAO = " & Formata_Dados(txtDescricao.Text, tpDados_Texto, tpNulo_Aceita) & _
    ...
    ElseIf Status = tpStatus_Incluir Then
      ...
      '
      objOrigem.InserirOrigem txtDescricao.Text
      '
      bRetorno = True
    End If
...
Private Function ValidaCampos() As Boolean
  ...
  If Len(txtDescricao.Text) = 0 Then
    strMsg = strMsg & "Informar a descrição da Origem" & vbCrLf
    Pintar_Controle txtDescricao, tpCorContr_Erro
    SetarFoco txtDescricao
  End If
  '
  If Len(strMsg) <> 0 Then
    TratarErroPrevisto strMsg, "[frmUserOrigemInc.ValidaCampos]"
    ValidaCampos = False
  Else
    ValidaCampos = True
  End If
...
Private Sub Form_Activate()
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserOrigemInc.Form_Activate]"
End Sub
