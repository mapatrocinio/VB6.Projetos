...
Begin VB.Form frmUserLinhaInc 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Inclusão da Linha"
   ClientHeight    =   2565
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10380
   ...
   End
End
Attribute VB_Name = "frmUserLinhaInc"
...
Private Sub cmdOK_Click()
  ...
  Case 0 'Inclusão/Alteração de Grupo cardápio
    ...
    strSql = "Select * From LINHA WHERE DESCRICAO = " & Formata_Dados(txtDescricao.Text, tpDados_Texto, tpNulo_Aceita) & _
    ...
    If Not objRs.EOF Then
      ...
      Set objRs = Nothing
      Set objGer = Nothing
      TratarErroPrevisto "Linha já cadastrada", "cmdOK_Click"
    ...
    ElseIf Status = tpStatus_Incluir Then
      ...
      '
      objLinha.InserirLinha txtDescricao.Text
      '
      bRetorno = True
    End If
...
Private Function ValidaCampos() As Boolean
  ...
  If Len(txtDescricao.Text) = 0 Then
    strMsg = strMsg & "Informar a descrição da Linha" & vbCrLf
    Pintar_Controle txtDescricao, tpCorContr_Erro
    SetarFoco txtDescricao
  End If
  '
  If Len(strMsg) <> 0 Then
    TratarErroPrevisto strMsg, "[frmUserLinhaInc.ValidaCampos]"
    ValidaCampos = False
  Else
    ValidaCampos = True
  End If
...
Private Sub Form_Activate()
  ...
  Exit Sub
trata:
  TratarErro Err.Number, Err.Description, "[frmUserLinhaInc.Form_Activate]"
End Sub
...
On Error GoTo trata
  ...
  ElseIf Status = tpStatus_Alterar Or Status = tpStatus_Consultar Then
    ...
    Set objLinha = New busApler.clsLinha
    Set objRs = objLinha.ListarLinha(lngLINHAID)
    '
    If Not objRs.EOF Then
