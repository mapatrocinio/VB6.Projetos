...
Private Sub cmdExcluir_Click()
  ...
  Case 3 'Exclusão de Plano
    ...
    SetarFoco grdPlano
  Case 4 'Exclusão de Produto
    '
    If Len(Trim(grdProduto.Columns("PKID").Value & "")) = 0 Then
      MsgBox "Selecione um Produto do convênio.", vbExclamation, TITULOSISTEMA
      SetarFoco grdProduto
      Exit Sub
    End If
    '
    ...
    '
    If MsgBox("Confirma exclusão do plano " & grdProduto.Columns("Produto").Value & "?", vbYesNo, TITULOSISTEMA) = vbNo Then
      SetarFoco grdProduto
      Exit Sub
    End If
    'OK
