...
Private Sub TratarTotais()
  On Error GoTo trata
  Dim objLoc    As busApler.clsLocacao
  Dim objDesp   As busApler.clsDespesa
  Dim objVda    As busApler.clsVenda
  Dim objExtra  As busApler.clsExtraForaUnidade
  Dim objRs     As ADODB.Recordset
  'Independente do Status, calcular os totais a serem pagos
  Select Case strStatusLanc
  Case "RE", "RC"
    'Recebimento para empresa e Recebimento
    Set objLoc = New busApler.clsLocacao
    '
  ...
  Case "DE"
    ...
    Set objDesp = New busApler.clsDespesa
    '
  ...
  Case "VD"
    'Recebimento para empresa
    Set objVda = New busApler.clsVenda
    '
  ...
  Case "EX"
    'Recebimento para empresa
    Set objExtra = New busApler.clsExtraForaUnidade
    '
...
Private Sub cmdCalculadora_Click()
  ...
  Dim objChequeResgate As Apler.frmUserLocChequeResgate
  If strStatusLanc = "DE" Then
    'Despesa calculadora vira resgatar cheque
    Set objChequeResgate = New Apler.frmUserLocChequeResgate
...
Private Sub cmdExcluir_Click()
  Dim objContaCorrente        As busApler.clsContaCorrente
  ...
  End If
  '
  Set objContaCorrente = New busApler.clsContaCorrente
