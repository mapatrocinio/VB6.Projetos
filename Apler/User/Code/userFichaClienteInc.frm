...
Private Sub cmdExcluir_Click()
  Dim objTabResp      As busApler.clsTabResp
  '
  On Error GoTo trata
'''  If Len(Trim(grdResponsabilidade.Columns("PKID").Value & "")) = 0 Then
'''    MsgBox "Selecione uma Responsabilidade.", vbExclamation, TITULOSISTEMA
...
'''  End If
'''  '
'''  Set objTabResp = New busApler.clsTabResp
'''  '
...
Private Sub cmdOk_Click()
  Dim objTabFichaClieLoc        As busApler.clsTabFichaClieLoc
  Dim objFichaCliente           As busApler.clsFichaCliente
  Dim objGeral                  As busApler.clsGeral
  ...
  End If
  Set objGeral = New busApler.clsGeral
  Set objFichaCliente = New busApler.clsFichaCliente
  '
  ...
  If Status = tpStatus_Alterar Then
    'Alterar Cliente
    Set objTabFichaClieLoc = New busApler.clsTabFichaClieLoc
    '
...
Private Sub Form_Load()
  ...
  Dim objRs                   As ADODB.Recordset
  Dim strSql                  As String
  Dim objFichaClie            As busApler.clsFichaCliente
  Dim objTabFichaClieLoc      As busApler.clsTabFichaClieLoc
  '
  blnFechar = False
  blnRetorno = False
  ...
  ElseIf Status = tpStatus_Alterar Or Status = tpStatus_Consultar Then
    Set objFichaClie = New busApler.clsFichaCliente
